...
export default function KreditTippPage() {
  return (
    <div style={{ maxWidth: 980, margin: '0 auto', padding: '1.25rem' }}>
      <h1 style={{ fontSize: '1.5rem', margin: '0.25rem 0 0.5rem' }}>KreditTipp</h1>
      <p style={{ color: '#555', fontSize: '0.95rem', marginBottom: '0.75rem' }}>
        Hier können Interessenten ihre Kontaktdaten und erste Informationen zum
        gewünschten Privatkredit hinterlassen.
      </p>
