          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link href="/kontakt" className="text-primary hover:text-primary">Kontakt</Link></li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-2">
                <li className="flex items-start">
                  ...
                  <span className="text-gray-300">
                    Brockmannstr. 204<br />48163 Münster<br /><br />
                    Besucheranschrift:<br />Glücksburger Str. 13<br />49477 Ibbenbüren
                  </span>
                </li>
